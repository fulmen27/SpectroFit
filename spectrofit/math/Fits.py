...
class Fits:
    ...
    def simple_gaussian(self):
        gmodel = Model(model_simple_gaussian)
    ...
    def double_gaussian(self):
        gmodel = Model(model_double_gaussian)
        gmodel.set_param_hint('sigma1', min=0)
    ...
    def simple_exp(self):
        gmodel = Model(model_simple_expo)
    ...
    def double_exp(self):
        gmodel = Model(model_double_expo)
    ...
    def double_lorentz(self):
        gmodel = Model(model_double_lorentz)
        gmodel.set_param_hint('gamma', min=0)
